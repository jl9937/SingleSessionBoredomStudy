...
function Chooser(_yCenter, _xCenter, _valueArray, scroll, _callbackOnValueSet)
{
    ...
    var upButton = new ClickButton("", this.buttonClicked.bind(this, +1), { picture: "../resources/interface/up.png", scale: 0.5, yPos: _yCenter - 85 });
    var downButton = new ClickButton("", this.buttonClicked.bind(this, -1), { picture: "../resources/interface/down.png", scale: 0.5, yPos: _yCenter + 70});
    if(scroll)
...
Chooser.prototype.updateText = function ()
{
    ...
    if (typeof this.callbackOnValueSet === "function")
    {
        this.callbackOnValueSet();
        this.callbackOnValueSet = function() {}
    }
}
